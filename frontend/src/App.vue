  ...
  <div class="p-6">
    ...
    <div class="flex flex-wrap gap-2 mb-8">
      <template v-if="brands.length">
        <a v-for="b in brands" :key="b.name" :href="b.url" target="_blank" class="px-3 py-1 bg-gray-100 rounded hover:bg-blue-100 text-blue-800 text-sm font-medium shadow">
          {{ b.name }}
        </a>
      </template>
      <template v-else>
